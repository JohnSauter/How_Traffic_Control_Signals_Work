...
To illustrate how this traffic control signal handles heavy traffic,
here is an animation showing traffic arriving from all directions,
and in the middle of the flood of traffic the intersection holds
traffic for a few seconds due to a nearby emergency vehicle.
...
A table of all of the events in the above animation would be excessively
long, so the following table just looks at the events surrounding
