...
times set to 1.5 seconds; and signal faces B, C, G and the pesestrian
...
The following are the events that take place assuming that there is only
one vehicle and that turns left after waiting at the light for a short time..
