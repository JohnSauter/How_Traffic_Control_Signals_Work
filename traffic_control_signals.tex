...
signal faces pse, psw, pne, and pnw set to 0, disabling gap detection
for pedestrians.
...
times set to 1.5 seconds; and signal faces pse, psw, B, C, pne, pnw,
F, and G to 0.4 seconds.
...
and signal faces pse, psw, pne, and pnw to 15.0 seconds.
...
Signal faces psw, pse, pnw, pne, D, H, and J do not have traffic
approaching sensors,
...
with signal faces
B, C, F and G green and A, psw, pse, D, E, pnw, pne, H, and J red and clear.
...
Signal faces psw and pse now receive permission to turn green.  They ask
signal faces A, B, C, F, and G to turn red.
While signal faces psw and pse are waiting for signal faces
A, B, C, F, and G to clear,
signal faces D, E, pne, pnw, H, and J request permission to turn green.
Signal face D conflicts with psw and pse, but E does not so it is allowed to
turn left flashing yellow out of order and immediately does so
since it does not conflict with A, psw, or pse.

Note: Check on signal faces H and J.
...
protected rather than permissive.  Similarly, when signal faces B and C
are clear, signal face E changes from flashing left arrow yellow to
steady left arrow green.

When signal faces A and E become clear signal faces psw, pse, pnw and pne
change from
Don't Walk to Walk.  Signal faces H and J are now permitted to turn green
out of order so they ask psw, pse, pnw and pne to turn red.

When signal faces psw, pse, pnw, and pne are clear,
signal faces H and J turn green
...
A and E, then through psw, pse, pnw, and pne, then H and J, and finally D.
...
\item[Passage Time]{The passage time for lanes B, C, F, and G is 3.5
  ...
  for the pedestrian signals is 1 second.}
\item[Maximum Green]{The maximum green interval for lanes B, C, F, and G
  ...
  20 seconds; for the pedestrian signals 10 seconds.}
\item[Yellow Change]{The yellow change interval is 5 seconds on lanes
  ...
  19 seconds on the pedestrian signals.}
