...
# File: Makefile.am, author: John Sauter, date: April 20, 2025.
#
...
pkgdatadir = $(datadir)/How_Traffic_Control_Signals_Work
pkgincludedir = $(includedir)/How_Traffic_Control_Signals_Work
pkglibdir = $(libdir)/How_Traffic_Control_Signals_Work
pkglibexecdir = $(libexecdir)/How_Traffic_Control_Signals_Work
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(dist_check_SCRIPTS) $(dist_check_DATA) \
...
am__DIST_COMMON = $(srcdir)/Makefile.in AUTHORS COPYING ChangeLog \
	INSTALL NEWS README install-sh missing test-driver
...
ACLOCAL = ${SHELL} '/home/jsauter/Projects/traffic_control_signals/How_Traffic_Control_Signals_Work/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/jsauter/Projects/traffic_control_signals/How_Traffic_Control_Signals_Work/missing' autoconf
AUTOHEADER = ${SHELL} '/home/jsauter/Projects/traffic_control_signals/How_Traffic_Control_Signals_Work/missing' autoheader
AUTOMAKE = ${SHELL} '/home/jsauter/Projects/traffic_control_signals/How_Traffic_Control_Signals_Work/missing' automake-1.16
AWK = gawk
CSCOPE = cscope
CTAGS = ctags
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"How_Traffic_Control_Signals_Work\" -DPACKAGE_TARNAME=\"How_Traffic_Control_Signals_Work\" -DPACKAGE_VERSION=\"0.33\" -DPACKAGE_STRING=\"How_Traffic_Control_Signals_Work\ 0.33\" -DPACKAGE_BUGREPORT=\"John_Sauter@systemeyescomputerstore.com\" -DPACKAGE_URL=\"\"github@github.com:How_Traffic_Control_Signals_Work.git\"\" -DPACKAGE=\"How_Traffic_Control_Signals_Work\" -DVERSION=\"0.33\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
ETAGS = etags
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} '/home/jsauter/Projects/traffic_control_signals/How_Traffic_Control_Signals_Work/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
PACKAGE = How_Traffic_Control_Signals_Work
PACKAGE_BUGREPORT = John_Sauter@systemeyescomputerstore.com
PACKAGE_NAME = How_Traffic_Control_Signals_Work
PACKAGE_STRING = How_Traffic_Control_Signals_Work 0.33
PACKAGE_TARNAME = How_Traffic_Control_Signals_Work
PACKAGE_URL = "github@github.com:How_Traffic_Control_Signals_Work.git"
...
STRIP = 
VERSION = 0.33
abs_builddir = /home/jsauter/Projects/traffic_control_signals/How_Traffic_Control_Signals_Work
abs_srcdir = /home/jsauter/Projects/traffic_control_signals/How_Traffic_Control_Signals_Work
abs_top_builddir = /home/jsauter/Projects/traffic_control_signals/How_Traffic_Control_Signals_Work
abs_top_srcdir = /home/jsauter/Projects/traffic_control_signals/How_Traffic_Control_Signals_Work
am__leading_dot = .
...
install_sh = ${SHELL} /home/jsauter/Projects/traffic_control_signals/How_Traffic_Control_Signals_Work/install-sh
...
pdfdir = ${docdir}
pkgpyexecdir = ${pyexecdir}/How_Traffic_Control_Signals_Work
pkgpythondir = ${pythondir}/How_Traffic_Control_Signals_Work
prefix = /usr/local
...
EXTRA_DIST = signal_ccc.svg signal_ccu.svg signal_rrr.svg \
	signal_cccl.svg signal_llll.svg fix_files.sh autogen.sh \
	left_turn_script.txt left_turn_delayed_script.txt \
	legalcode.txt mutcd11thedition.pdf multiple_script.txt \
	...
	MUTCD_Ped_Signal_-_Steady_hand.svg MUTCD_Ped_Signal_-_Walk.svg \
	pedestrian_and_left_turn_script.txt pedestrian_script.txt \
	references.bib Signal_Timing_Manual_Second_Edition_22097.pdf \
	traffic_control_signals.py traffic_control_signals.tex \
	state_diagram.txt signal_ccc_Green.svg signal_ccc_Red.svg \
	signal_ccc_Yellow.svg signal_ccu_Green.svg signal_ccu_Red.svg \
	signal_ccu_Yellow.svg signal_Dark_3.svg signal_Dark_4.svg \
	signal_cccl_Green.svg signal_cccl_Red.svg \
	signal_cccl_Yellow.svg signal_llll_Flashing_Yellow.svg \
	signal_llll_Green.svg signal_llll_Red.svg \
	signal_llll_Yellow.svg signal_rrr_Green.svg signal_rrr_Red.svg \
	signal_rrr_Yellow.svg car-38800411-right.svg \
	car-38800411-up.svg truck-51893967-up.svg \
	truck-51893967-right.svg man_walking_right.svg background.png \
	process_events.py build_RPMs.sh build_animation.sh \
	render_animation.sh build_video.sh \
	How_Traffic_Control_Signals_Work.spec
...
check-TESTS: $(dist_check_SCRIPTS) $(dist_check_DATA)
	...
	exit $$?;
recheck: all $(dist_check_SCRIPTS) $(dist_check_DATA)
	@test -z "$(TEST_SUITE_LOG)" || rm -f $(TEST_SUITE_LOG)
	@set +e; $(am__set_TESTS_bases); \
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
verify_files.sh.log: verify_files.sh
	@p='verify_files.sh'; \
	b='verify_files.sh'; \
...
.PHONY: all all-am am--refresh check check-TESTS check-am clean \
	...
	mostlyclean-generic pdf pdf-am pdf-local ps ps-am recheck \
...
left_turn_delayed_table.tex : traffic_control_signals.py \
left_turn_delayed_script.txt
	python3 ${srcdir}/traffic_control_signals.py --table-level 4 \
--table-file ${builddir}/left_turn_delayed_table.tex --duration 400 \
--table-start 199 --script ${srcdir}/left_turn_delayed_script.txt \
...
check_output.txt : traffic_control_signals.py left_turn_script.txt
	python3 ${srcdir}/traffic_control_signals.py \
...
%_animation.csv : %_script.txt traffic_control_signals.py
	python3 ${srcdir}/traffic_control_signals.py \
--script "${srcdir}/$<" --duration 600 --events-file "$@" \
--last-event-time "last_event_time_$(*F)_animation.txt"

# Render the animation as individual images.  We use the PDF file
# as a marker to day that the frames have been generated.
